...
//    val context = LocalContext.current
    ...
    Scaffold(snackbarHost = { SnackbarHost(appState.snackbarHostState) }, topBar = {
        MyTopBar(
        ...
        ModalNavigationDrawer(modifier = Modifier.padding(paddingValues),
            ...
            drawerContent = {
                ModalDrawerSheet {
                    ...
                    items.forEach { item ->
                        NavigationDrawerItem(icon = { Icon(item.icon, contentDescription = null) },
            ...
            content = {
                Box(
                    ...
                    Text(
                        if (appState.drawerState.isClosed) stringResource(R.string.swipe_to_open)
                        else stringResource(R.string.swipe_to_close)
                    )
                }
            })
    }
